...
export default function Hotel() {
    return (
        <section className="bg-[#F8F8F8] items-center justify-center">
                    ...
                    <div className="flex items-center justify-between py-[20px] px-[70px]">
                        ...
                        <div className="flex align-middle items-center w-full justify-between">
                            <div className=" flex pl-[50px] pr-[50px] gap-4 mx-auto">
                                ...
                                <a href="/travel">
                                        <h4 className="text-xl text-gray-700 font-medium p-[10px] gap-[2px] hover:bg-gray-700 hover:bg-opacity-30 rounded-xl">
                                        Travel
                                        </h4>
                                </a>
                                <a href="/rental">
